    ...
    public static func wrapInTemplate(_ bodyHTML: String, template: String? = nil) -> String {
        ...
        <head>
            ...
            <style>
                ...
                @media (prefers-color-scheme: dark) { body { color: #e6edf3; background: #0d1117; } a { color: #58a6ff; } code:not([class*="language-"]) { background: #343942; color: #e6edf3; } pre { background: #161b22 !important; } th, td { border-color: #3d444d; } tr { background-color: #0d1117; border-top-color: #3d444db3; } tr:nth-child(2n) { background-color: #151b23; } blockquote { border-left-color: #3d444d; color: #8b949e; } hr { border-top-color: #3d444d; } h1, h2 { border-bottom-color: #3d444d; } h6 { color: #8b949e; } }
